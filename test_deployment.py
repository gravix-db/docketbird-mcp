...
def check_environment_variables():
    ...
    if not DOCKETBIRD_API_KEY:
        missing_vars.append("DOCKETBIRD_API_KEY")
    ...
    if missing_vars:
        ...
        print_colored("export DOCKETBIRD_API_KEY=your_api_key", "yellow")
        sys.exit(1)
